...
function science(){
 ...
 async function loadUsersci(){
     try{
         const url = "https://api.nytimes.com/svc/topstories/v2/science.json?api-key=M9gsE0ftboJ2kfsQHnLg5n8YPaixrNrG"
 ...
 async function foosci(){
     
        //console.log(abc)
       var some_thing=await loadUsersci();
