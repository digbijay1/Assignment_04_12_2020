...
function magazine(){
 ...
 async function loadUserma(){
     try{
         const url = "https://api.nytimes.com/svc/topstories/v2/magazine.json?api-key=M9gsE0ftboJ2kfsQHnLg5n8YPaixrNrG"
 ...
 async function foo3(){
        ...
        //console.log(abc)
       var some_thing=await loadUserma();
