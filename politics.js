...
function politics(){
 ...
 async function loadUser123(){
     try{
         const url = "https://api.nytimes.com/svc/topstories/v2/politics.json?api-key=M9gsE0ftboJ2kfsQHnLg5n8YPaixrNrG"
 ...
 async function foo2(){
        ...
        //console.log(abc)
       var some_thing=await loadUser123();
