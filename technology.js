...
function technology(){
 ...
 async function loadUsertech(){
     try{
         const url = "https://api.nytimes.com/svc/topstories/v2/technology.json?api-key=M9gsE0ftboJ2kfsQHnLg5n8YPaixrNrG"
 ...
 async function footech(){
     
        //console.log(abc)
       var some_thing=await loadUsertech();
